...
Por otro lado, el arrastre aerodinámico es causado por la interacción del satélite con la alta atmósfera, este arrastre genera un torque debido al desfase entre el centro de masa y el centro de presión del CubeSat. Por su parte, el campo geomagnético puede afectar la orientación y el control de los vehículos debido a los torques magnéticos. Estos últimos se aparecen gracias a los lazos de corriente que generan dipolos y magnetizaciones residuales sobre el satélite\cite{Giesselman2006}.
...
\end{equation}
Donde $M$ es el momento magnético terrestre ($M = 7.96\:10^{15}\:tesla\:m^3$) y el radio de la órbita $R$ es igual a $(6370 + 500)$ $10^3$ $m$. como en el cálculo anterior. Por consiguiente, el torque magnético es igual a:
$$T_m = 4.91\;10^{-7} Nm$$
