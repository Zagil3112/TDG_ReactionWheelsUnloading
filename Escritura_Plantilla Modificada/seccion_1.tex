...
Tomando la \textbf{eq (\ref{eq:torque_mgt})} 
...
\begin{figure}[h]
	\begin{center}
		\includegraphics[scale=0.45]{imagenes/modelo_dinamico/magnetorquer.png}\\
	\end{center}
	\caption{Funcionamiento Magnetorquers.}
	\label{fig:mgt}
	\footnotesize{Nota. Fuente \cite{tes:Niccolo}}
\end{figure}
