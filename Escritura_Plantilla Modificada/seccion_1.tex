...
\begin{figure}[!h]
	\begin{center}
		\includegraphics[scale=0.50]{imagenes/resultados/Desaturation.PNG}\\
	\end{center}
...
\begin{figure}[!h]
	\begin{center}
		\includegraphics[scale=0.5]{imagenes/resultados/Desaturation2.PNG}\\
	\end{center}
...
\begin{itemize}
	...
	\item \textbf{Apuntamiento hacia el Nadir}: Con el fin de simular un apuntamiento constante a la tierra se evalúa una respuesta tipo rampa para alcanzar una velocidad de rotación constante.
	Para ello se determinó el periodo de la órbita con la expresión:
	\begin{gather}
		T_o = 2\pi\sqrt{\frac{a^3}{GM_{tierra}}}\\
		\omega =
	\end{gather}
...
\begin{figure}[!h]
	\begin{center}
		\includegraphics[scale=0.55]{imagenes/resultados/orbitas.PNG}\\
	\end{center}
	\caption{Órbitas evaluadas en los diferentes perfiles de misión.}
...
\paragraph{Órbita Ecuatorial}
  
% Tabla indices de desempeño
\begin{table}[!h]
	...
	\begin{tabular}{r|lllll|l}
		\multicolumn{1}{l|}{\textbf{ID}} & \textbf{Controlador}                  & \mbox{\boldmath$e_{ref}$}   & \mbox{\boldmath$\Delta h$} & \mbox{\boldmath$P_{mgt}$}   & \mbox{\boldmath$P_{Rw}$}    & \textbf{Total}      \\ 
		\hline
...
\subsubsection{Perfil de misión 3 : Apuntado a Nadir}
