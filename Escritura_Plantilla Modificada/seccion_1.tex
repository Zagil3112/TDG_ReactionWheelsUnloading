...
\begin{figure}[!h]
	\begin{center}
		\includegraphics[scale=0.6]{imagenes/resultados/Desaturation.PNG}\\
	\end{center}
	\caption{Implementación del cálculo de indices de desempeño.}
...
\begin{figure}[!h]
	\begin{center}
		\includegraphics[scale=0.6]{imagenes/resultados/Desaturation2.PNG}\\
	\end{center}
	\caption{Implementación del cálculo de indices de desempeño.}
...
%\begin{figure}[!h]
%	\begin{center}
%		\includegraphics[scale=0.35]{imagenes/resultados/orbita_zero/yaw weeoe.PNG}\\
%	\end{center}
%	\caption{Implementación del cálculo de indices de desempeño.}
%	\label{fig:indicesP}	 	
%\end{figure}
