...
%2R3 |Iz − Iy| sin(2) (4.1)
%where:
%Tg: is the maximum gravity torque
%μ: is the Earth’s gravitational parameter (3.986 1014 m3/s2)
%R: is the orbit radius (6.370 + 600) 103 m
%: is the maximum deviation of the orbit frame Z-axis (see 3.1.3)
%Iz, Iy: are the moments of inertia about z and y-axis
%The value of  represents the inclination in which the torque arm will act. Then
%sin(2) = 1 is the worst-case value that it can take. Then solving 4.1 we get:
%Tg = 3 × 3.986 1014
%2 × (6.970 103)3 |0, 0609 − 0, 1052| × 1 (4.2)
%Tg = 7, 8171 10−8 Nm
