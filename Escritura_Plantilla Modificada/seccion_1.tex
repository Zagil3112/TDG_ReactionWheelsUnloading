...
Por otro lado, se conoce la transformación :
$$
...
Finalmente, usando las propiedad \textbf{(\ref{eq:transformada1})} descrita en la sección de transformación de marcos de referencia, se tiene que:
