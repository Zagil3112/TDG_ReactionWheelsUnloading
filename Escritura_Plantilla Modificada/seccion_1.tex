...
\begin{figure}[!ht]
	\begin{center}
		\includegraphics[scale=0.5]{imagenes/controladores/lqr.PNG}\\
	\end{center}
	\caption{LQR simplificado y controlador en cascada con valor de referencia.}
	\label{fig:lqr}	 	
\end{figure}

\begin{figure}[!ht]
	\begin{center}
		\includegraphics[scale=0.5]{imagenes/controladores/cascada.PNG}\\
	\end{center}
