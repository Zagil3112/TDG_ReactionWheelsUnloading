...
Con el fin de obtener la matriz de inercia se 
...
\begin{figure}[h!]
	...
	\subfloat[Gatito]{
		...
		\includegraphics[width=0.382\textwidth]{imagenes/modelo_dinamico/eyassat_medicion.jpg}}
	\subfloat[Tigre]{
		\label{fig:placa_cube}
		\includegraphics[width=0.382\textwidth]{imagenes/modelo_dinamico/placa_medicion.jpg}}
...
\begin{figure}[!h]
	\begin{center}
		\includegraphics[scale=0.4]{imagenes/modelo_dinamico/escenario.PNG}\\
	\end{center}
	\caption{Simulink}
	\label{fig:escenario}
	\textit{}
