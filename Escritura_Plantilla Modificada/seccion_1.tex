...
\begin{gather}
		\boldsymbol{v}=\left(\frac{\mathrm{d} \boldsymbol{r}}{\mathrm{d} t}\right)_i=\frac{\mathrm{d} \boldsymbol{R}}{\mathrm{d} t}+\left(\frac{\mathrm{d} \boldsymbol{\rho}}{\mathrm{d} t}\right)_b+\omega \times \boldsymbol{\rho}\label{eq:velocidad}\\	
...
El torque neto de fuerzas externas sería:
...
\end{equation}
 ...
 Al expandir la expresión para la aceleración tal como se hizo anteriormente, se tiene que :
...
$$
$\omega_b=\left[\begin{array}{l}\omega_x \\ \omega_y \\ \omega_z\end{array}\right]=$ Vector de velocidad angular en el marco del cuerpo.\\
